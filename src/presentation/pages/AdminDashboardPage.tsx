      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6 mb-8 mt-4">
          <div>
            ...
            <p className="text-garage-darkSub text-sm mb-4">Beheer je wagenpark, pas auto's aan en publiceer nieuwe occasions.</p>
            <div className="inline-flex items-center gap-2 bg-white p-1.5 rounded-xl border border-garage-border shadow-sm">
              <Link to="/beheerpaneel" className="px-5 py-2 rounded-lg font-bold text-sm bg-garage-bg text-white">
                Voorraad
              </Link>
              <Link to="/beheerpaneel/reviews" className="px-5 py-2 rounded-lg font-bold text-sm text-garage-darkSub hover:bg-slate-50 transition-colors">
                Reviews
              </Link>
            </div>
          </div>
          <Link to="/beheerpaneel/toevoegen" className="btn-primary flex items-center justify-center gap-2 py-3 px-6 shrink-0 w-full md:w-auto">
